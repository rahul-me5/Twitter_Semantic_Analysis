...
with open(r'C:\\Users\\Rahul\\Desktop\\DS_Project\\lg_model.pkl', 'rb') as model_file:
    lg_model = pickle.load(model_file)
    
with open(r'C:\\Users\\Rahul\\Desktop\\DS_Project\\tfidf_vectorizer.pkl', 'rb') as vectorizer_file:
